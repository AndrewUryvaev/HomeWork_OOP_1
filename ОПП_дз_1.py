...
first_student = Student("Андрей", "Урываев", "м")
first_student.finished_courses += ["Introduction to programming"]
first_student.courses_in_progress += ["GIT"]
first_student.courses_in_progress += ["Python"]

second_student = Student("Сергей", "Пономарев", "м")
...
second_lecturer = Lecturer("Алена", "Ботицкая")
second_lecturer.courses_attached += ["GIT"]

first_reviewer = Reviewer("Елена", "Никитина")
first_reviewer.courses_attached += ["Python"]

second_reviewer = Reviewer("Евгений", "Шмаргунов")
...
first_student.rate_lesson(second_lecturer, "GIT", 7)
first_student.rate_lesson(second_lecturer, "GIT", 7)
...
print(f"Средняя оценка за дз у Урываева больше, чем у Пономарева {second_student < first_student}")
print(f"Средняя оценка за лекции у Ботицкой меньше, чем у Булыгина {second_lecturer < first_lecturer}\n")
